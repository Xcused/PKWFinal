...
<link rel="stylesheet" type="text/css" href="acc.css">
    ...
    <header class="block">
        ...
        <ul class="header-menu horizontal-list">
            ...
            <li>
                <a class="header-menu-tab" href="index.php"><span class="icon fontawesome-user scnd-font-color"></span>Click This To Enter Main Menu</a>
            </li>
            <li>
        ...
        <div class="profile-menu">
            ...
            <div class="profile-picture small-profile-picture">
                <img width="40px" alt="Anne Hathaway picture" src="http://ti.umy.ac.id/wp-content/uploads/2020/03/as.jpg">
            </div>
        </div>
    </header>
    ...
    <div class="middle-container container">
        <div class="profile block"> 
            ...
            <div class="profile-picture big-profile-picture clear">
                <img width="150px" alt="Anne Hathaway picture" src="http://ti.umy.ac.id/wp-content/uploads/2020/03/as.jpg" >
            </div>
            <h1 class="user-name">Asroni, Ir., S.T., M.Eng.</h1>
            <div class="profile-description">
                <p class="scnd-font-color">Bidang Keahlian : Data Warehouse, Data Minning, Web Application Development, Web Design, Semantic Web</p>
            </div>
